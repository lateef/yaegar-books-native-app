...
import PersonalAccountTypeSelection from './lightboxes/PersonalAccountTypeSelection';
import BusinessAccountTypeSelection from './lightboxes/BusinessAccountTypeSelection';
...
export function registerScreens(store, Provider) {
    ...
    Navigation.registerComponent('PersonalAccountTypeSelection', () => PersonalAccountTypeSelection, store, Provider);
    Navigation.registerComponent('BusinessAccountTypeSelection', () => BusinessAccountTypeSelection, store, Provider);
    Navigation.registerComponent('NameInputBox', () => NameInputBox, store, Provider);
    Navigation.registerComponent('AddAccount', () => AddAccount, store, Provider);
